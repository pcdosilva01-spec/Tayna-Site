        ...
        <div className="p-6 sm:p-8 bg-card border border-border rounded-3xl">
          <form className="space-y-4">
            ...
            <label className="flex items-start gap-2 text-xs text-muted-foreground cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-border accent-brand mt-0.5" />
            ...
            <button type="submit" className="w-full flex items-center justify-center gap-2 py-3.5 bg-brand text-white rounded-xl font-semibold text-sm hover:bg-brand/90 transition-colors">
          ...
          <button className="w-full flex items-center justify-center gap-3 py-3.5 border border-border rounded-xl text-sm font-medium hover:bg-secondary transition-colors">
